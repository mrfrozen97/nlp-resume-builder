...
WORK_EX = open("../../data/resumes/projects/projects.txt", "r").read().split("\n\n")
...
for i in JOB_DES:
    ...
    for j in WORK_EX:
        ...
        output = run_ollama_cli(
    f"""Given the following job description and project description, determine whether the project is a good match for the job.

Be lenient in your evaluation — if the project shows related skills, classify as positive.
